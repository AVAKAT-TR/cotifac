"""
Django settings for mvt_django project.
...
SECRET_KEY = 'django-insecure-lzw_cph@c5%b)5pxeeqji^y#_apsv3e7zuw65k18_3o*c9(lq9'
...
print(dir(dj_database_url))  # Muestra los atributos disponibles
...
LOGIN_URL = "login"               # si no estás logueado, te manda al login
LOGIN_REDIRECT_URL = "orden_list" # a dónde ir después de loguearte
